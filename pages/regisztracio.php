<?php
if (filter_input(INPUT_POST, "regisztraciosAdataok", FILTER_VALIDATE_BOOLEAN, FILTER_NULL_ON_FAILURE)) {
...
<div class="container">
    <form action="#" method="post">
        ...
        <button type="button" class="btn btn-primary" name="regisztraciosAdatok" value="true">Regisztráció</button>
    </form>
</div>
